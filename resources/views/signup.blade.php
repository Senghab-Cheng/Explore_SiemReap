...
<style>
    ...
    .form-input:focus {
        border-color: rgb(59, 121, 201)1 !important;
    ...
    <div class="main-center">
      ...
      @auth
        <div class="form-container" style="text-align:center;">
          <h2 class="form-title">You are logged in!</h2>
      ...
      @else
        ...
        <div class="form-container">
          ...
          <p class="form-desc">Don't have an account yet? Create one here.</p>
          @if($errors->any())
        ...
        @endif
          <form action="/register" method="POST">
            ...
            <input type="text" name="name" class="form-input" placeholder="Enter your username"  required>
